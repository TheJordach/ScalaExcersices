...
come to live in the town. How many years does the town need to see its population greater or
...
def nbYear(p0: Int, percent: Double, aug: Int, p: Int): Int = {
  ...
  while (population < p) {
    val increase = (population * percent/100).toInt + aug
    population+=increase
    numberOfYear += 1
